...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-939-93910-305-0": [
			{ type: "text", sub_type: "message", message: "Bomb Debuff", message_RU: "Зайти в большой круг", check_func: () => first_boss_debuff },
		...
		"s-939-1000-108-0": [{ type: "text", sub_type: "message", message: "Combo Incoming", message_RU: "Волна назад + Огненная волна" }],
		"s-939-1000-113-0": [{ type: "text", sub_type: "message", message: "Back Combo", message_RU: "Волна назад + Огненная волна" }],
		"s-939-1000-115-0": [{ type: "text", sub_type: "message", message: "Front Combo", message_RU: "Волна вперед + Огненная волна" }], // preceded by 108, all the time or most of the time?
