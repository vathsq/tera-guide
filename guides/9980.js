...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-980-1000-102-0": [{ type: "text", sub_type: "message", class_position: "tank", message: "Stun", message_RU: "Стан (танк)" }],
		...
		"s-980-1000-108-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", delay: 2800 }],
		...
		"s-980-2000-106-2": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд" }],
		// "s-980-2000-108-0": [{ type: "text", sub_type: "message", message: "Front Attack (Stun)", message_RU: "Удар вперед (стан)" }],
		"s-980-2000-301-0": [{ type: "text", sub_type: "message", message: "Target", message_RU: "Таргет" }],
		...
		"s-980-3000-105-0": [{ type: "text", sub_type: "message", class_position: "tank", message: "Push Front", message_RU: "Откид вперед" }],
		...
		"s-980-3000-112-0": [{ type: "text", sub_type: "message", message: "Target", message_RU: "Таргет" }],
		"s-980-3000-112-2": [{ type: "text", sub_type: "message", message: "Front | Back", message_RU: "Передняя | Задняя" }],
		"s-980-3000-113-0": [{ type: "text", sub_type: "message", message: "Pushback (Left)", message_RU: "Откид назад" }], // left
		"s-980-3000-114-0": [{ type: "text", sub_type: "message", message: "Pushback (Right)", message_RU: "Откид назад" }], // right
		...
		"s-980-3000-309-0": [{ type: "text", sub_type: "message", message: "Jump", message_RU: "Прыжок" }]
	};
};
